...
const seedDatabase = async () => {
  try {
    ...
    const products = await Product.create([
      { name: 'Fresh Milk 1L', category: 'Dairy', sku: 'MILK001', quantity: 150, price: 280, minStock: 50, supplier: 'Dairy Farm Ltd', barcode: 'MILK001' },
      { name: 'White Bread', category: 'Bakery', sku: 'BREAD001', quantity: 80, price: 120, minStock: 30, supplier: 'Golden Bakery', barcode: 'BREAD001' },
      { name: 'Tomatoes 1kg', category: 'Vegetables', sku: 'VEG001', quantity: 15, price: 350, minStock: 50, supplier: 'Fresh Farms', barcode: 'VEG001' },
      { name: 'Chicken 1kg', category: 'Meat', sku: 'MEAT001', quantity: 45, price: 850, minStock: 20, supplier: 'ABC Poultry', barcode: 'MEAT001' },
      { name: 'Rice 5kg', category: 'Grains', sku: 'RICE001', quantity: 0, price: 600, minStock: 10, supplier: 'Rice Mills', barcode: 'RICE001' },
      { name: 'Orange Juice 1L', category: 'Beverages', sku: 'BEV001', quantity: 30, price: 320, minStock: 75, supplier: 'Fruit Drinks Co', barcode: 'BEV001' },
      ...
      { name: 'Fresh Apples 1kg', category: 'Fruits', sku: 'FRUIT001', quantity: 120, price: 450, minStock: 40, supplier: 'Fresh Farms', barcode: 'FRUIT001' },
    ...
    console.log('========================================');
    console.log('\nLogin Credentials:');
    console.log('  Admin:         admin@smartsuper.lk / admin123');
    console.log('  Cashier:       john@smartsuper.lk / cashier123');
    console.log('  Stock Manager: jane@smartsuper.lk / stock123');
    console.log('========================================\n');
